"""
Tarefas do framework criado com python
1. Orientação a objetos para abstração
2. Mapa de roteamento de URLs
3. Configuração de templates
4. Objeto callable (WSGI)
5. método 'run' para executar a aplicação
"""
import json
import cgi #modulo não exite no python 13
import re
